...
legend('Outbound L2', 'Outbound L2 max', 'Return L2', 'Return L2 max'); title(['\Delta V = f(Asteroid)']);
...
legend('Outbound L2', 'Outbound L2 max', 'Return L2', 'Return L2 max'); title(['t0 = f(Asteroid)']);
...
legend('Outbound L2', 'Outbound L2 max', 'Return L2', 'Return L2 max'); title(['tf = f(Asteroid)']);
