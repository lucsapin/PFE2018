function [resDrift, resFig, resB, resP2H, correspondingPoint] = propagateCompare(destination, typeSimu, numAsteroid, numOpti, dist, TmaxN, m0, Sansmax, choixDyn, propagation)
