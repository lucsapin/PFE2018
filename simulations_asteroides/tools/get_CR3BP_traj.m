function [resDrift, correspondingPoint] = get_CR3BP_traj(destination, typeSimu, numAsteroid, numOpti, dist, TmaxN, m0, Sansmax, choix)
  ...
  [times_out, ~, time_Hill, state_Hill, ~, ~, states, states_q_L1, states_q_L2] = propagate2Hill(outputOptimization, dist);
