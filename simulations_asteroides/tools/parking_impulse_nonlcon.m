function [cin, ceq] = parking_impulse_nonlcon(X, xOrb_epoch_t0_Ast, q0_SUN_AU, t0_p, ratio)
  ...
  odefun      = @(t,x) rhs_BP(t, x, muCR3BP, muSun, rhoS, thetaS0, t0_p, omegaS, 3);
  ...
  % State at t0_p + dt1_p
  [times, states_q_L] = ode45(odefun, [t0_p t0_p+dt1_p]*UC.jour/UC.time_syst, q0, OptionsOde);
  ...
  [times, states_q_L] = ode45(odefun, [t0_p+dt1_p t0_p+dt1_p+dtf_p]*UC.jour/UC.time_syst, q1, OptionsOde);
...
return
  ...
  function qdot = rhs_BP(t, q, mu, muSun, rhoS, thetaS0, t0_p, omegaS, choix)
