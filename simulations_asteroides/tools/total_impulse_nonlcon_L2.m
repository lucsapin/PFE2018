function [cin, ceq, delta_Vf_o, delta_Vf_r_L2] = total_impulse_nonlcon_L2(X, xOrb_epoch_t0_Ast, ratio, time_min_on_ast, time_max_on_ast)
...
% get L2 state at time t0
[qMoon_EMB_LD_t0, ~, qL2_EMB_LD_t0] = get_Moon_Earth_L2_State_Cart_LD(t0_o);
...
normal_o = cross(qMoon_EMB_LD_t0(1:3),qMoon_EMB_LD_t0(4:6));
...
[qM, ~, qL2_EMB_LD] = get_Moon_Earth_L2_State_Cart_LD(tf_r);
% EMB's state in SUN, LD
qEMB_SUN_LD = final_state_EMB_f(:);
...
vf_EMB = delta_Vf_r_L2*UC.AU/UC.LD; % = (xC0(4:6)-xEMB0(4:6))*AU/LD;
