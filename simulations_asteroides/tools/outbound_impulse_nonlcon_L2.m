function [cin, ceq, delta_Vf_o] = outbound_impulse_nonlcon_L2(X, xOrb_epoch_t0_Ast, ratio, tfmin, tfmax)
...
[qMoon_EMB_LD_t0, ~, qL2_EMB_LD_t0] = get_Moon_Earth_L2_State_Cart_LD(t0);
...
normal = cross(qMoon_EMB_LD_t0(1:3),qMoon_EMB_LD_t0(4:6));
