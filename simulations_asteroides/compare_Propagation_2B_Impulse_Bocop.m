...
dir_results = ['./results/compare_inside_Hill/2B_Impulse/' destination '/in_progress_results/'];
...
if(strcmp(init_choice, 'none1')==1)
    ...
    init.X0             = [{'state.0'     , 'constant', (q0(1)+qf(1))/2}; % q11
                           ...
                           {'optimvars.1' , 'constant', 0.1};             % dV11
                           {'optimvars.2' , 'constant', 0.1};             % dV12
                           {'optimvars.3' , 'constant', 0.1};             % dV13
                           {'optimvars.4' , 'constant', 0.1};             % dV21
                           {'optimvars.5' , 'constant', 0.1};             % dV22
                           {'optimvars.6' , 'constant', 0.1}];             % dV23
else
