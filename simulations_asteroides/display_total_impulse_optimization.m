...
function display_total_impulse_optimization(numAsteroid, numOpti)

%
repOutput = 'results/total_impulse/';
...
% ----------------------------------------------------------------------------------------------------
titre = ['Outbound-Return -- Asteroid no ' int2str(numAsteroid) ' -- Optimization no ' int2str(numOpti) '/' int2str(nbOpti)];
