function out = getconstdistearth(arg1,arg2,arg3,arg4)
%-------------------------------------------------------------------------------------------
%
%    getconstdistearth -- extra routine (in afun.f90)
%
%-------------------------------------------------------------------------------------------
%
%    Matlab Usage
%
%        out = getconstdistearth(t, z,     par) : single arc
%        out = getconstdistearth(t, z, ti, par) : multiple arcs
%
%    Inputs
%
...
%try
    out = getconstdistearth_m(t, z, ti, par);
%catch err
