...
#include "header_pathcond"
{
	...
	double min_dist_2_earth = constants[19];

	path_constraints[0] 	= u1*u1+u2*u2+u3*u3 - 1.0;
	path_constraints[1]	= min_dist_2_earth*min_dist_2_earth - ((q1-mu)*(q1-mu)+q2*q2+q3*q3); // distance to Earth 
}
