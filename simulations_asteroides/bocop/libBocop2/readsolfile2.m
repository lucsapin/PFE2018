...
%function for reading a .sol file generated by Bocop
% input: full path to .sol file
% output: time, state, control, control_average



function [time,stage,state,control,control_average,algebraic,constants,optimvars,...
    adjoint,zl_state,zu_state,zl_control,zu_control,...
    objective,constraints_Infnorm,iterations,boundarycond_mult] = readsolfile2(path,verbose)
