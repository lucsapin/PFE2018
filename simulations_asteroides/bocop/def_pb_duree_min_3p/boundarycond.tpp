...
#include "header_boundarycond"
{
  ...
  boundary_conditions[21] = qL21              - final_state[14];
  boundary_conditions[22] = qL22              - final_state[15];
  boundary_conditions[23] = qL23              - final_state[16];
  boundary_conditions[24] = qL24              - final_state[17];
  boundary_conditions[25] = qL25              - final_state[18];
  boundary_conditions[26] = qL26              - final_state[19];
  // masse finale libre
}
