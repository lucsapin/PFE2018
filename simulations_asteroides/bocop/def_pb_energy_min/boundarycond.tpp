...
#include "header_boundarycond"
{
	...
	double v3_f	 	= constants[11]; 
   	...
   	boundary_conditions[3] =  initial_state[3]-v1_0;
    	...
    	boundary_conditions[6] =  initial_state[6]-0.0;
   	boundary_conditions[7] =  final_state[0]-q1_f;
    	boundary_conditions[8] =  final_state[1]-q2_f;
    	boundary_conditions[9] =  final_state[2]-q3_f;
   	boundary_conditions[10] =  final_state[3]-v1_f;
    	boundary_conditions[11] =  final_state[4]-v2_f;
    	boundary_conditions[12] =  final_state[5]-v3_f;
