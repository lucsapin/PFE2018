...
% rotating frame
function hFig = check_outbound_aligned_EMB_L2(arg1, arg2)
...
if(nargin==2)
    ...
    %
    repOutput = 'results/outbound_impulse_L2/';
...
% Display EMB
position_EMB = [0.0 0.0 0.0]; display_EMB(position_EMB, 'outbound_t0');
...
display_L2(q_t0_L2_EMB_LD(1:3), 'outbound_t0');
display_Moon2(q_t0_Moon_EMB_LD(1:3), 'outbound_t0');

disp('display t0+dt1+dtf');
[q_tf_Moon_EMB_LD, ~, q_tf_L2_EMB_LD] = get_Moon_Earth_L2_State_Cart_LD(t0+dt1+dtf);
display_L2(q_tf_L2_EMB_LD(1:3), 'outbound_t0_dt1_dtf');
display_Moon2(q_tf_Moon_EMB_LD(1:3), 'outbound_t0_dt1_dtf');
