...
[resDrift_3BP, ~, resB_3BP, resP2H, pointMinDistL2_3BP] = get_all_traj(destination, typeSimu, numAsteroid, numOpti, dist, TmaxN, m0, choix);
...
[resDrift_2BS, ~, resB_2BS, ~, pointMinDistL2_2BS] = get_all_traj(destination, typeSimu, numAsteroid, numOpti, dist, TmaxN, m0, choix);
...
[resDrift_AH, ~, resB_AH, ~, pointMinDistL2_AH] = get_all_traj(destination, typeSimu, numAsteroid, numOpti, dist, TmaxN, m0, choix);
...
% display_L2(); hold on;
% plot3(zB_3BP(1,:), zB_3BP(2,:), zB_3BP(3,:), 'r-', 'LineWidth', DC.LW); hold on;
% plot3(zB_2BS(1,:), zB_2BS(2,:), zB_2BS(3,:), 'm--', 'LineWidth', DC.LW); hold on;
% plot3(zB_AH(1,:), zB_AH(2,:), zB_AH(3,:), 'b--', 'LineWidth', DC.LW);
%
% legend('Moon', 'Earth', 'L2', 'Bocop 3BP', 'Bocop 2BS', 'Bocop AH');
