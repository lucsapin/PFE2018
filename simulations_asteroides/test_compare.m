...
figure;
plot3(zB_EMB(1,:), zB_EMB(2,:), zB_EMB(3,:), color_EMB); hold on;
plot3(zB_L2(1,:), zB_L2(2,:), zB_L2(3,:), color_L2); hold on;
plot3(Q_CR3BP_L2(1,:), Q_CR3BP_L2(2,:), Q_CR3BP_L2(3,:), color_L2, 'LineWidth', LW_L2); hold on;
plot3(Q_CR3BP_EMB(1,:), Q_CR3BP_EMB(2,:), Q_CR3BP_EMB(3,:), color_EMB, 'LineWidth', LW_EMB);
display_Earth(); display_Moon();
xlabel('q_1');
ylabel('q_2');
zlabel('q_3');
title('Target EMB : bocop vs drift compare');
legend('Bocop EMB', 'Bocop L2', 'Drift compare L2', 'Drift compare EMB');
view(0,90);
