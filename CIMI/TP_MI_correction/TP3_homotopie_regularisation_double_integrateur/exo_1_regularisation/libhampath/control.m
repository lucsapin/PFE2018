function out = control(arg1,arg2,arg3,arg4)
%-------------------------------------------------------------------------------------------
%
%    control -- extra routine (in afun.f90)
%
%-------------------------------------------------------------------------------------------
%
%    Matlab Usage
%
%        out = control(t, z,     par) : single arc
%        out = control(t, z, ti, par) : multiple arcs
%
%    Inputs
%
