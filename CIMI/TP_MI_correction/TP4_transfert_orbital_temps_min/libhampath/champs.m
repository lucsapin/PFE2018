function out = champs(arg1,arg2,arg3,arg4)
%-------------------------------------------------------------------------------------------
%
%    champs -- extra routine (in afun.f90)
%
%-------------------------------------------------------------------------------------------
%
%    Matlab Usage
%
%        out = champs(t, z,     par) : single arc
%        out = champs(t, z, ti, par) : multiple arcs
%
%    Inputs
%
