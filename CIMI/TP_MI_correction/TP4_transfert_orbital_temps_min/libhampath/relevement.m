function out = relevement(arg1,arg2,arg3,arg4)
%-------------------------------------------------------------------------------------------
%
%    relevement -- extra routine (in afun.f90)
%
%-------------------------------------------------------------------------------------------
%
%    Matlab Usage
%
%        out = relevement(t, z,     par) : single arc
%        out = relevement(t, z, ti, par) : multiple arcs
%
%    Inputs
%
